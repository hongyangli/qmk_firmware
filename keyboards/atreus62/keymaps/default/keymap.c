...
[_DEFAULT] = { /* qwerty */
		{ KC_ESC,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_TRNS,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DELT},
		{ KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_TRNS,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC },
		{ KC_LCTL,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_TRNS,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_RCTL },
		{ KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LGUI,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT },
		{ KC_LALT,  KC_TILD, KC_LBRC, KC_RBRC,  KC_LALT,KC_ENT, KC_RGUI,   KC_SPC,  KC_MINS,  KC_PLUS, KC_PIPE, KC_QUOT,  KC_RALT }
},
